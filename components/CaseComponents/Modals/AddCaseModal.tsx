...
mutation AddCaseMutation($description: String = "", $name: String = "") {
    insert_cases_one(object: {description: $description, name: $name}) {
      id
      name
      description
    }
        ...
        {data ? (
          <FormControl fullWidth>
            ...
            >
              ...
              */}
                {data
                  ? data.category.map((index: number, category : ManagementCategory) => {
